...
const items: MenuItem[] = [
  ...
  getItem(
    ...
    [
      getItem("List", "3", <NavLink to="/admin/product"></NavLink>),
  ...
  getItem(
    ...
    [getItem("List", "6", <NavLink to="/admin/category"></NavLink>),
    getItem("Thêm mới", "7", <NavLink to="/admin/category/addCate"></NavLink>)
    ]
  ),
  getItem(
    "Order",
